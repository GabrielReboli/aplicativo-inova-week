...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: 'bold', color: '#1F2C73', textAlign: 'center', marginBottom: 16 },
  description: { fontSize: 16, color: '#555', textAlign: 'center', marginBottom: 16, lineHeight: 24 },
  divider: { height: 1, backgroundColor: '#E0E0E0', marginVertical: 16 },
  leader: { fontSize: 18, fontWeight: 'bold', color: '#1F2C73', marginBottom: 16, textAlign: 'center' },
  leaderName: { fontSize: 20, fontWeight: 'bold', color: '#F280B6' },
  subtitle: { fontSize: 20, fontWeight: '600', color: '#1F2C73', marginBottom: 12 },
  memberCard: {
